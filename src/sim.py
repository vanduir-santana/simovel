...
class Simulador():
    ...
    def obter_opcoes_financiamento(self) -> list[OpcaoFinanciamento]:
        ...
        params = {
            ...
            'noPerguntaFatorSocial': 'Mais de um comprador ou dependente?',
            # TODO: implementar mais de um comprador
            'dePerguntaFatorSocial': 'Informar se possui mais de um comprador na proposta e/ou possui dependente.',
            'isVoltar': 'false',
            'isFiltrosDefault': '',
            'nomeConvenio': '',
    ...
    def procurar(self, s: str, l: list, max_res: int = 10) -> list[str]:
        ...
        idêntico retorna apenas um item, caso contrário retorna uma lista
        de str.
